...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      if(${list.get(0).total != ''})
		  teens = parseInt("${list.get(0).total}");
      if(${list.get(1).total != ''})
		  twenties = parseInt("${list.get(1).total}");
      if(${list.get(2).total != ''})
		  thirties = parseInt("${list.get(2).total}");
      if(${list.get(3).total != ''})
		  fourties = parseInt("${list.get(3).total}");
      if(${list.get(4).total != ''})
		  fifties = parseInt("${list.get(4).total}");
      if(${list.get(5).total != ''})
		  senior = parseInt("${list.get(5).total}");
