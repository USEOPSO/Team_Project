...
$(function(){
	...
	$.ajax({
	  url: "${path}/doctor/resultBasicList",
	  method: "GET",
	  dataType: "JSON",
	        ...
	        <div class="container">
				...
				<div style="padding-top: 20px">
					<table class="table table-bordered">
					    ...
					    <tr>
					      <td width="10%" style="vertical-align: middle">혈소판 수(10^3/㎣)</th>
					 ...
					 <table class="table table-hover">
						...
						<c:forEach var="dto" items="${list}">
							<tr>
								...
								<td align="center"><a href="customerDetail1?reserveNo=${dto.reserveNo}&memberNo=${dto.memberNo}">${dto.name}</a></td>
