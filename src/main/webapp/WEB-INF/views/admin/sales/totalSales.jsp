							...
							<tr>
								<c:forEach var="yts" items="${ytslist}" varStatus="status">
									...
									<c:if test="${!status.last}">
										...
										<c:if test="${yts.paymentWay ne null}">
											<c:if test="${yts.paymentWay eq '카드'}">
												<td align="center">
													<input type="hidden" name="date" value="${yts.paymentYear}년">
													${yts.paymentYear}년
												</td>
												 <td align="center">
											...
											<c:if test="${yts.paymentWay eq '현금'}">
												<c:if test="${card == 0}">
													<td align="center">
														<input type="hidden" name="date" value="${yts.paymentYear}년">
														${yts.paymentYear}년
											...
											<c:if test="${yts.paymentWay eq '카카오페이'}">
												<c:if test="${card == 0}">
													<td align="center">
														<input type="hidden" name="date" value="${yts.paymentYear}년">
														${yts.paymentYear}년
										...
										<c:if test="${yts.paymentWay eq null}">
											<%-- 카드가 없는 경우 --%>
											<c:if test="${card == 0}">
												<td align="center">
													<input type="hidden" name="date" value="${yts.paymentYear}년">
											...
											<td align="center">
												...
												<c:set var="total" value="${total + yts.total}" />
												<fmt:formatNumber value="${yts.total}" pattern="#,###원"/>
											</td>
