...
<div class="page-wrapper chiller-theme toggled">
  ...
  <main class="page-content">
    <!-- 식사요법 시작 -->
			<div class="container">
	        	<!-- 테이블 데이터 내용 시작 -->
	        	<h3 class="display-4">의약품 정보</h3><!-- ?medicineNo={dto.medicineNo} -->
	        	<form action="setMedicUpdate?medicineNo=${medicine.medicineNo}" method="post" enctype="multipart/form-data">
		        	...
		        	<div class="form-group">
					    ...
					    <img src="${medicine.img}" width="80">
					    <input type="file" class="input" name="image"  id="image" size="20" accept="images/*">
					 </div>
		        	<hr>
		        	<div class="form-group">
					...
					<div align="center" style="margin-top: 20px;">
						<button class="w-75 btn btn-primary btn-lg" type="submit">등록</button>
					</div>
				</form>
			</div>
			<!-- container 끝 -->
