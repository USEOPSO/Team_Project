	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$("#btnInsert").click(function(){
				...
				document.mentalInsert3.submit(); /* action에서 지정한 페이지로 이동 */
			});
		});          
	</script>
<style>
        ...
        <div id="content">
			...
			<div class="container">
				...
				<div style="padding-top: 50px">
		 		...
		 		<form action="/customer/mental_3Action?suervey2No=${dto.survey2No}" name="mentalInsert3" method="post">
		 			<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
					<input type="hidden" name="hiddenId" value="0">
					<table border="1" align="center" width="800px"><!--  class="table table-hover" -->
							<tr class="info">
								<th class="color" colspan="6">상황3. 동료선수를 관찰하는 상황</th><!-- 이전 클래스 class="text-center" -->
							</tr>
							<tr>
								<th colspan="6">
								동료선수가 시합에서 실수하는 상황을 생각해보자.<br>
								예를 들어 페널티킥의 실축. 평균대에서 떨어지는 것, 패스 미스 등을 하는 상황을 가정하자.<br> 
								약 1분간 눈을 감고 동료선수가 시합의 중요한 시점에서 실수를 하는 장면을 가능한 선명하게 상상해보자<br>
								</th>
							</tr>
							...
							<tr>
								<td class="text-center"><input type="radio" id="q1" name="q1" value="1"></td>
								<td class="text-center"><input type="radio" id="q1" name="q1" value="2"></td>
								<td class="text-center"><input type="radio" id="q1" name="q1" value="3"></td>
								<td class="text-center"><input type="radio" id="q1" name="q1" value="4"></td>
								<td class="text-center"><input type="radio" id="q1" name="q1" value="5"></td>
							</tr>	
							...
							<tr>
								<td class="text-center"><input type="radio" id="q2" name="q2" value="1"></td>
								<td class="text-center"><input type="radio" id="q2" name="q2" value="2"></td>
								<td class="text-center"><input type="radio" id="q2" name="q2" value="3"></td>
								<td class="text-center"><input type="radio" id="q2" name="q2" value="4"></td>
								<td class="text-center"><input type="radio" id="q2" name="q2" value="5"></td>
							</tr>	
							...
							<tr>
								<td class="text-center"><input type="radio" id="q3" name="q3" value="1"></td>
								<td class="text-center"><input type="radio" id="q3" name="q3" value="2"></td>
								<td class="text-center"><input type="radio" id="q3" name="q3" value="3"></td>
								<td class="text-center"><input type="radio" id="q3" name="q3" value="4"></td>
								<td class="text-center"><input type="radio" id="q3" name="q3" value="5"></td>
							</tr>	
